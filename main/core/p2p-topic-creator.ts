 ...
 */
export async function autoCreateP2PTopicAfterPairing(params: any): Promise<any> {
  const {
    topicModel,
    channelManager,
    localPersonId,
 ...
 */
export async function ensureP2PTopicForIncomingMessage(params: any): Promise<any> {
  const {
    topicModel,
    channelManager,
    leuteModel,
