...
export class QRGenerator {
   ...
   */
  async generateQRForMessage(options: any): Promise<any> {
   ...
   */
  async generateQRForTopic(options: any): Promise<any> {
    ...
    try {
      ...
      throw new Error(`Failed to generate topic QR: ${(error as Error).message}`);
    }
  }
   ...
   */
  createInviteUrl(params: any): any {
   ...
   */
  async generateBatchQRCodes(messages: any): Promise<any> {
   ...
   */
  validateQRAgainstMessage(qrText: any, message: any): any {
    try {
