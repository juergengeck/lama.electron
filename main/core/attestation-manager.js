...
export class AttestationManager {
    ...
    async createAttestation(params) {
        const { messageHash, messageVersion, attestedContent, attestationType = 'reproduction-correct', attestationClaim, topicId } = params;
    ...
    async getAuditTrail(messageHash) {
        ...
        // Sort by timestamp
        attestations.sort((a, b) => new Date(a.timestamp).getTime() - new Date(b.timestamp).getTime());
        return attestations;
    }
    /**
