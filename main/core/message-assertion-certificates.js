...
export class MessageAssertionManager {
  ...
  async createMessageAssertion(message, messageHash) {
    try {
      ...
      console.log('[MessageAssertion] Stored assertion data:', assertionHash.substring(0, 8));
      ...
      console.log('[MessageAssertion] Created AffirmationCertificate:', certificateHash.substring(0, 8));
  ...
  async verifyMessageAssertion(certificateHash, expectedMessageHash) {
    try {
      console.log('[MessageAssertion] Verifying certificate:', certificateHash.substring(0, 8));
