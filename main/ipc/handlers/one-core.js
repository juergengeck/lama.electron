        ...
        try {
            ...
            try {
                ...
                if (myProfile?.nickname) {
                    ...
                    const nameDesc = myProfile.personDescriptions.find((d) => d.$type$ === 'PersonName' && d.name);
                    if (nameDesc?.name) {
            ...
            for (const someone of others) {
                try {
                    ...
                    // Then try communicationEndpoints in profile
                        ...
                        const emailEndpoint = profile.communicationEndpoints.find((e) => e.$type$ === 'Email' && e.email);
                    ...
                    if (profile) {
                        ...
                        // If personDescriptions is a method, call it
                            ...
                            try {
                                ...
                                const nameDesc = descriptions?.find((d) => d.$type$ === 'PersonName' && d.name);
                                if (nameDesc?.name) {
                                    displayName = nameDesc.name;
