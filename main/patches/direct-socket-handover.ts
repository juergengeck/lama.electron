...
class DirectSocketHandover {
   ...
   */
  registerPairingToken(token: any, localInstanceId: any, remoteInstanceId: any) {
   ...
   */
  onPairingSuccess(token: any, localInstanceId: any, remoteInstanceId: any) {
   ...
   */
  registerSpareConnectionExpectation(instanceId: any) {
   ...
   */
  isSpareConnection(connection: any, remoteInstanceId: any) {
   ...
   */
  async sendConnectionHandover(connection: any): Promise<unknown> {
