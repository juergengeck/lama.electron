 ...
 */
async function createAIMessage(text, senderId, previousMessageHash, channelIdHash, topicIdHash, modelId) {
    if (!text) {
...
export { MessageCertificateTypes, createAIMessage, createUserMessage, isAIMessage, sha256Hash };
