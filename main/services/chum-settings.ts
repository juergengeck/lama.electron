...
class ChumSettingsHelper {
   ...
   */
  async createSettingsObject(category: any, data: any, authority = 'DEVICE_ADMIN'): Promise<unknown> {
   ...
   */
  async syncConnectionSettings(connectionSettings: any): Promise<any> {
   ...
   */
  async syncNetworkSettings(networkSettings: any): Promise<any> {
   ...
   */
  async addSettingsToChumSync(settingsObject: any): Promise<any> {
    try {
   ...
   */
  async testSettingsValidation(category: any, data: any): Promise<any> {
   ...
   */
  async exampleConnectionSettingsUpdate(): Promise<any> {
   ...
   */
  async exampleNetworkSettingsUpdate(): Promise<any> {
