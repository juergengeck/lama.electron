...
// DISABLED - This creates a conflicting instance in the browser
// The real instance is created by real-browser-instance.ts
// debugOneCore().then(result => {
//   console.log('Debug result:', result)
// })

// Export for manual debugging if needed
export { debugOneCore }